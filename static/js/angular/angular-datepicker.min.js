...
(function withAngular(angular, navigator) {
  ...
  var A_DAY_IN_MILLISECONDS = 86400000
    ...
    , generateMonthAndYearHeader = function generateMonthAndYearHeader(prevButton, nextButton) {
      ...
      if (isMobile) {
        ...
        return [
          ...
          '</div>',
          '<div class="_720kb-datepicker-calendar-header">',
            '<div class="_720kb-datepicker-calendar-header-middle _720kb-datepicker-mobile-item _720kb-datepicker-calendar-year">',
    ...
    , generateHtmlTemplate = function generateHtmlTemplate(prevButton, nextButton) {
      ...
      var toReturn = [
        ...
        '<div class="button-wrap"><a class="cb secondary" ng-click="selectDate($event)">Cancel</a></div></div>'
      ]
    ...
    , datepickerDirective = function datepickerDirective($window, $rootScope, $compile, $locale, $filter, $interpolate) {



      var linkingFunction = function linkingFunction($scope, element, attr) {

          $scope.$watch('$parent.gigdate', function(v){
              $rootScope.gigdate = v;
          }, true)
        //get child input
        ...
        if ($scope.datepickerAppendTo &&
          ...
          angular.element(document.getElementsByClassName($scope.datepickerAppendTo.replace('.', ''))[0]).append($compile(angular.element(htmlTemplate))($scope, function afterCompile(el) {
            ...
            moreCalendars = angular.element(el);
          }));
		...
		$scope.selectDate = $rootScope.selectDate;
  ...
  angular.module('720kb.datepicker', [])
               .directive('datepicker', ['$window', '$rootScope', '$compile', '$locale', '$filter', '$interpolate', datepickerDirective]);
}(angular, navigator));
